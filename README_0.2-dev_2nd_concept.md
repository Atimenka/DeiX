...
> **ПРИМЕЧАНИЕ ДЛЯ РАЗРАБОТЧИКОВ / LLM**: Данный документ представляет собой концепт-спецификацию версии v0.2-dev. Действующий код системы находится в директории `src/`.
