...
// TWRP/OrangeFox + Fastbootd/EDL. Zero External Dependencies, совместимо с no_std.
    ...
    /// * `registry`    — HashMap<BootStage, Vec<Command>>: карта стадия -> команды.
    ...
    pub struct InitParser {
        pub registry: HashMap<BootStage, Vec<Command>>,
    ...
    impl InitParser {
        ...
        pub fn parse(&mut self, source: &str) -> HashMap<BootStage, Vec<Command>> {
